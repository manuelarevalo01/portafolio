 ...
 useEffect(() => {
  ...
  return (
    <main className="content-banner-container" /* ref={main} */>
          ...
          <div className="item-content-left">
            ...
            <div className="item-content-subtitle">
              <p className="txt-subtitle">
                Titulado de la Universidad Industrial de Santander; mi formación
                me permite crear e implementar soluciones innovadoras y
                oportunas, por lo cual puedo desarrollar, controlar, operar y
                mantener dispositivos, equipos y sistemas electrónicos.
                Profesional solidario, responsable, ético, puntual, creativo,
                tolerante, comprometido con el trabajo, cuidadoso con el medio
                ambiente, con capacidad para trabajar en equipos
                interdisciplinarios. Con competencias para aprender
                autónomamente y adaptarse a las realidades del medio, en
                consonancia con el continuo cambio tecnológico y científico.
                Poseo sólida fundamentación en telecomunicaciones, procesamiento
                de señales, informática, desarrollo de software (FrontEnd),
                máquinas eléctricas e instrumentación electrónica.
              </p>
            </div>
      ...
      <section className="content-ourProduct">
            ...
            <div className="items-content-ourProduct-card">
              ...
              <div className="content-item-text">
                ...
                <p className="item-subtext">
                  ...
                  diarias en el área de las Telecomunicaciones, correspondientes
                  a transmisión de primer y segundo nivel, para equipos Huawei,
                  ZTE y CISCO, parte eléctrica y electromecánica. Mantenimientos
                  preventivos, mantenimientos correctivos, atención de
                  emergencias y disponibilidad las veinticuatro horas del día,
                  los siete días de la semana para realizar dichas tareas
                  programadas y repentinas.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="items-content-ourProduct-card">
              ...
              <div className="content-item-text">
                ...
                <p className="item-subtext">
                  ...
                  por estudiantes y que beneficiaron a la Institución educativa.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="items-content-ourProduct-card">
              ...
              <div className="content-item-text">
                ...
                <p className="item-subtext">
                  ...
                  materias tales como: Maquinas y Equipos, Electiva Programa de
                  Proyectos, Control Eléctrico, Sistemas Automatizados,
                  Circuitos Eléctricos DC, Dibujo Electromecánico, entre otras.
                  Seguimiento y apoyo de trabajos de investigación a estudiantes
                  en sus últimos semestres académicos para la obtención de
                  titulo de grado.
                </p>
              </div>
            </div>
            ...
            <div className="items-content-ourProduct-card">
              ...
              <div className="content-item-text">
                ...
                <p className="item-subtext">
                  ...
                  Junior, trabajamos en la interfaz desde el código para que el
                  usuario pueda interactuar, donde nos encargamos de la parte
                  visual de la web, también nos encargamos de programar el
                  código para hacer que la interfaz sea atractiva, intuitiva y
                  que la experiencia de usuario o navegación sea agradable para
                  su público objetivo. Aptitudes: ·HTML5 ·Hojas de estilos en
                  cascada(CSS) ·SASS ·Vue.js ·JavaScript.
                </p>
              </div>
            </div>
          </div>
